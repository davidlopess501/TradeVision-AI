  ...
  return (
    <div className="space-y-5">
      ...
      <section className="grid gap-3 sm:grid-cols-2">
        {ASSET_LIST.map((assetItem) => (
          <div
            key={assetItem.code}
            className="animate-fade-up"
          >
            <AssetCard
              asset={assetItem.code}
              result={
                results[
                  assetItem.code
                ] ?? null
      ...
      <section className="animate-fade-up">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-1 text-[11px] font-semibold text-accent-400 hover:text-accent-300"
          >
            Ver backtest
          ...
          <StatCard
            ...
            value={
              stats.cumulativePnl >= 0
                ? `+${stats.cumulativePnl.toLocaleString(
                    'pt-BR',
                    {
                ...
                .map((item) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <span className="grid h-8 w-8 place-items-center rounded-lg bg-ink-800 text-[11px] font-bold text-accent-300">
                        {item.asset}
                      </span>
                      ...
                      <div>
                        ...
                        <div className="text-[11px] text-slate-600 tabular">
                          {formatDateTime(
                            item.createdAt,
                          )}
                        </div>
